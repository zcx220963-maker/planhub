...
public class AIController {
    ...
    public ResponseEntity<Map<String, Object>> getConversations(
        ...
        String path = "/orchestrator/conversations?user_id=" + actualUserId + 
    ...
    public ResponseEntity<Map<String, Object>> getConversationDetail(
            ...
            Authentication authentication,
            HttpServletRequest request) {
        return forwardGet("/orchestrator/conversations/" + sessionId, authentication, request);
    }
    ...
    public ResponseEntity<Map<String, Object>> deleteConversation(
            ...
            Authentication authentication,
            HttpServletRequest request) {
        return forwardDelete("/orchestrator/conversations/" + sessionId, authentication, request);
    }
